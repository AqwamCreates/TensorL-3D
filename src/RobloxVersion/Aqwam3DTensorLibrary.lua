...
function AqwamTensorLibrary3D:broadcast(tensor1, tensor2)
	...
	if (isTensor1Broadcasted) then
		...
		local targetDimensionArray = AqwamTensorLibrary3D:getDimensionSizeArray(tensor2)

		tensor1 = AqwamTensorLibrary3D:expand(tensor1, targetDimensionArray)

	elseif (isTensor2Broadcasted) then

		local targetDimensionArray = AqwamTensorLibrary3D:getDimensionSizeArray(tensor1)
...
function AqwamTensorLibrary3D:sum(tensor, dimension)
	...
	local dimensionSizeArray = AqwamTensorLibrary3D:getDimensionSizeArray(tensor)
...
function AqwamTensorLibrary3D:getDimensionSizeArray(tensor)
...
function AqwamTensorLibrary3D:transpose(tensor, dimensionIndexArray)
	...
	local newDimensionArray = AqwamTensorLibrary3D:getDimensionSizeArray(tensor)
...
function AqwamTensorLibrary3D:isSameTensor(tensor1, tensor2)
	...
	local dimensionSizeArray1 = AqwamTensorLibrary3D:getDimensionSizeArray(tensor1)

	local dimensionSizeArray2 = AqwamTensorLibrary3D:getDimensionSizeArray(tensor2)
...
function AqwamTensorLibrary3D:applyFunction(functionToApply, ...)
	...
	local dimensionSizeArray = AqwamTensorLibrary3D:getDimensionSizeArray(tensorsArray[1])
...
function AqwamTensorLibrary3D:mean(tensor, dimension)
	...
	local tensorSizeArray = AqwamTensorLibrary3D:getDimensionSizeArray(tensor)
	...
	local meanTensorSizeArray = AqwamTensorLibrary3D:getDimensionSizeArray(meanTensor)
...
function AqwamTensorLibrary3D:standardDeviation(tensor, dimension)
	...
	local standardDeviationTensorSizeArray = AqwamTensorLibrary3D:getDimensionSizeArray(standardDeviationTensor)
